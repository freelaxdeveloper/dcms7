...
<div id="main">
            ...
            <div id="navigation_user">
                <div class="body_width_limit clearfix">
                    <a ng-show="+user.group" class="<?= $user->group ? '' : 'ng-hide' ?>"
                       href="/pages/menu.user.php" ng-bind="user.nick"><?= $user->nick ?></a>
                    <a ng-show="+user.friend_new_count" class='ng-hide'
                       href='/pages/my.friends.php' ng-bind="str.friends"><?= __("Друзья") ?></a>
                    <a ng-show="+user.mail_new_count" class='ng-hide'
                       href='/pages/my.mail.php?only_unreaded' ng-bind="str.mail"><?= __("Почта") ?></a>
                    <a ng-hide="+user.group" class="ng-hide"
                       href="/pages/login.php?return={{URL}}" ng-bind="translates.auth"><?= __("Авторизация") ?></a>
                    <a ng-hide="+user.group" class="ng-hide"
                       href="/pages/reg.php?return={{URL}}" ng-bind="translates.reg"><?= __("Регистрация") ?></a>
    ...
    <div id="footer">
        <div class="body_width_limit">
                    ...
                    <span id="language">
                        <?= __("Язык") ?>:<a href='/pages/language.php?return={{URL}}'
